    ...
    data: [
      {
        ...
        storeName: "XuXu Shop",
        no: "ECOM55-50484-50",
        img: "https://cl.lnwfile.com/a7dliu.jpg",
            ...
            <div className="grid grid-cols-12 border rounded-md p-3 mb-2">
              <div className="grid col-span-12">
                <div className="grid grid-cols-12 mb-2">
                  ...
                  <div className="grid col-span-6">
                    <div className="text-end text-red-500">ที่ต้องจัดส่ง</div>
                  </div>
                </div>
              </div>
              <div className="grid col-span-12">
                ...
                <div className="grid grid-cols-12 mb-2">
                  <div className="grid col-span-6">
                    <div className="flex">
                      ...
                      <div className="ml-2 text-[#26aa99]">
              ...
              <div className="grid col-span-12 pt-2 border border-b-white border-r-white border-l-white">
                <div className="grid grid-cols-12 mb-2">
                  <div className="grid col-span-8 content-center">
                    <div className="flex">
                      ผู้ขายจะขนส่งสินค้าให้บริการขนส่ง ภายในวันที่ {item.date}
                    </div>
                  </div>
                  <div className="grid col-span-4 justify-end">
                    <button className="border p-2 bg-red-500 text-white rounded-lg">
                      ติดต่อผู้ขาย
                    </button>
                  </div>
                </div>
